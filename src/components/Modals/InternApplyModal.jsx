...
const InternApplyModal = ({ onClose, onLoginClick }) => {
            ...
            <div className="modal-content internship-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="register-form">
                    ...
                    <div className="register-footer">
                        <p>Already applied? <button className="btn-link" onClick={onLoginClick}>Login Here</button></p>
                    </div>
                </form>
            </div>
        </div>
...
export default InternApplyModal;
